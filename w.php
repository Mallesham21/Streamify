...
if ($content_id > 0) {
    ...
    // Fetch users specific rating if logged in
    if ($user_id) {
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7">
                    ...
                    <div class="hero-meta">
                        ...
                        <?php if ($content['content_type'] === 'movie'): ?>
                            <span class="text-light stat-item"><i class="bi bi-clock"></i> 120 min</span>
                        <?php else: ?>
                    ...
                    <div class="hero-stats">
                        ...
                        <span class="text-light stat-item"><i class="bi bi-star"></i> <?= $content['rating'] ?>/10 rating</span>
                    ...
                    <div class="ratio ratio-16x9">
                        <video id="player" playsinline controls data-poster="<?= htmlspecialchars($content['thumbnail_url']) ?>">
                            <?php if ($content['content_type'] === 'movie' && $content['video_path']): ?>
                                <source src="<?= htmlspecialchars("https://pixeldrain.com/api/file/".$content['video_path']."?download") ?>" type="video/mp4">
                ...
                <div class="content-card mb-4 w-100">
                    <div class="card-body">
                        ...
                        <div class="text-light">
                            <p><strong>Release Year:</strong> <?= htmlspecialchars($content['release_year']) ?></p>
                            <p><strong>Type:</strong> <?= $content['content_type'] === 'movie' ? 'Movie' : 'TV Show' ?></p>
                            <p><strong>Rating:</strong> <?= $content['rating'] ?>/10</p>
                            <p><strong>Views:</strong> <?= number_format($content['views']) ?></p>
            ...
            <div class="modal-content bg-dark">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-around mb-3">
                        ...
                        <a href="#" class="text-decoration-none text-center">
                            <div class="bg-danger rounded-circle p-3 mb-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control bg-secondary text-light" value="<?= "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>" readonly>
        ...
        commentForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                  ...
                  // Replace the newComment creation in your JavaScript with this:
const newComment = `
    <div class="d-flex gap-3 mb-4 p-3 content-card w-100">
